...
set gross_service_amount = excluded.gross_service_amount,
    ...
    autobooth_rent_applied_amount = excluded.autobooth_rent_applied_amount,
...
values
  ...
  ('fade@bvrb3r.demo', 'barber_user', '{loc-hyde}', 'barber-fade', null),
