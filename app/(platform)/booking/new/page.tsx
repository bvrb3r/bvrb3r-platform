    ...
    return (
      <ClientAppShell activeTab="search" mode="guest">
        <Card className="mx-auto max-w-2xl rounded-[34px] p-6 sm:p-8">
          <p className="surface-label text-[#e4f9b8]">Booking access</p>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link href="/discover?entry=guest" className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#C4F24E] px-5 text-sm font-semibold text-black transition hover:bg-[#d9f985]">
              Continue browsing
            </Link>
            <Link href="/login?redirect=/booking/new" className="inline-flex min-h-12 items-center justify-center rounded-full border border-white/10 bg-black/25 px-5 text-sm font-semibold text-white transition hover:border-[#C4F24E]/24 hover:text-[#e4f9b8]">
              Sign in as client
            </Link>
          </div>
        </Card>
