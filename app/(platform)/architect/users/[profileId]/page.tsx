...
export default async function ArchitectUserDetailPage({
  params
}: {
  ...
  try {
    ...
    console.error("[Architect Users] detail page loader failed", error);
    initialData = {
      account: null,
      warnings: ["Architect user detail is partially unavailable. Live account views will show true empty states where reads failed."]
    };
  }
