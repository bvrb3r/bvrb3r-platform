...
export default function DiscoveryStylesPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-4 sm:px-6 lg:px-10 lg:py-8">
      <Card className="rounded-[36px] p-6 sm:p-8">
        <p className="surface-label text-[#e4f9b8]">Discovery update</p>
        <h1 className="mt-4 text-balance text-4xl font-semibold sm:text-5xl" data-display="true">
          Style browsing is parked during soft launch.
        </h1>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-white/64">
          Clients should use the canonical discovery flow while marketplace ranking, trust, availability, and booking stay on one shared truth path.
        </p>
