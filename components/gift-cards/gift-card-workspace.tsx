    ...
    <main className="min-h-screen bg-[#060708] px-4 py-5 text-[#F5F1E8] sm:px-8">
      ...
      {tab === "buy" ? (
        <form onSubmit={(event) => void startPurchase(event)} className="mx-auto mt-8 max-w-5xl">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-white/55">Good at any chair on BVRB3R, or lock it to a verified barber or shop. Stripe funds it; the service payout follows the normal 5% BVRB3R platform fee and separately disclosed adjustments.</p>
