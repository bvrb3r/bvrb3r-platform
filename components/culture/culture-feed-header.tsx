  ...
  return (
    <section className="overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(18,18,18,0.98),rgba(5,5,5,0.98))] shadow-[0_26px_60px_rgba(0,0,0,0.28)]">
      <div className="grid grid-cols-[3rem_minmax(0,1fr)_3rem] items-center gap-3 px-4 py-4 sm:px-5">
        <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#e4f9b8]/18 bg-[#e4f9b8]/10 text-[#e4f9b8]" aria-label={avatarLabel(surface)}>
          <UserRound className="h-5 w-5" />
        </div>
        <div className="min-w-0 text-center">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-[#e4f9b8]">BVRB3R</p>
            ...
            return (
              <button
                ...
                className={[
                  ...
                  active
                    ? "border-[#e4f9b8]/36 bg-[#e4f9b8] text-[#050505]"
