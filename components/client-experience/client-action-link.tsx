...
const baseClassName =
  "inline-flex min-w-0 items-center justify-center gap-2 rounded-full border font-semibold leading-none transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d4f97a] focus-visible:ring-offset-2 focus-visible:ring-offset-black";
...
const variantClassNames = {
  ...
  secondary:
    "border-white/12 bg-[linear-gradient(180deg,rgba(34,34,34,0.96),rgba(12,12,12,0.98))] text-white shadow-[0_14px_28px_rgba(0,0,0,0.22)] hover:border-[#c4f24e]/24 hover:bg-[linear-gradient(180deg,rgba(38,38,38,0.98),rgba(14,14,14,0.99))] hover:text-white",
  outline:
    "border-[#9bff2f]/45 bg-transparent text-[#e4f9b8] hover:border-[#d4f97a]/72 hover:bg-[#d4f97a]/8 hover:text-[#efffd4]"
} as const;
