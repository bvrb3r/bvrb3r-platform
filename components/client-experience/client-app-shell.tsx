  ...
  return (
    <div className="bvr-screen app-screen relative overflow-x-clip text-[var(--text-primary)]">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute inset-x-0 top-0 h-64 bg-[linear-gradient(180deg,rgba(124,255,0,0.1),transparent_72%)]" />
        <div className="absolute inset-x-0 bottom-0 h-44 bg-[linear-gradient(0deg,rgba(124,255,0,0.06),transparent_76%)]" />
      </div>
