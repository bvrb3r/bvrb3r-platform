  ...
  const barberMoreSections: MoreSectionGroupConfig[] = [
    ...
    },
    {
      ...
      rows: [
        ...
        { title: "Transactions", subtitle: "Barber sales, receipts, spending, refunds, failed payments, subscriptions, and payout movement", onClick: () => openBusinessTool("transactions"), icon: <ReceiptText className="h-5 w-5" />, testId: "business-tool-transactions" },
        { title: "Tax Information", subtitle: "Tax forms and documents for barber earnings", href: "/dashboard/barber/more?section=payouts", icon: <FileText className="h-5 w-5" /> }
      ]
    },
    {
    ...
    <div className="relative space-y-6 overflow-hidden pb-4 text-white" data-testid="barber-settings-screen" data-more-modal-root="barber">
      ...
      <div className="relative space-y-6">
        ...
        <MoreControlHub
          ...
          roleScope="barber"
          rows={[
            { title: "Notifications & Alerts", subtitle: "Messages, reminders, booking alerts, payout alerts, and business alerts", href: "/dashboard/barber/more?section=settings", icon: <BellRing className="h-5 w-5" /> },
            { title: "Preferences", subtitle: "App experience, display, dashboard defaults, and business behavior", href: "/dashboard/barber/more?section=settings", icon: <SlidersHorizontal className="h-5 w-5" /> },
