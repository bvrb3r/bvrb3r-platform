...
function TeamActionLink({
  ...
  return (
    <Link
      href={href}
      className="block rounded-[14px] px-3 py-2.5 text-sm font-bold text-white/72 transition hover:bg-white/[0.05] hover:text-[#C4F24E]"
    >
      {children}
    </Link>
  );
    ...
    <div className="space-y-7" data-testid="owner-team-workspace">
        ...
        <div className="relative space-y-6">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              <p className="text-xs font-black uppercase tracking-[0.18em] text-[#C4F24E]">Shop Command Calendar</p>
            ...
            {weekStrip.map((day) => {
              ...
              return (
                ...
                >
                  ...
                  {appointmentCount > 0 ? (
                    <span className="mt-2 rounded-full border border-[#C4F24E]/20 bg-[#C4F24E]/10 px-2 py-0.5 text-[10px] font-black uppercase tracking-[0.08em] text-[#e4f9b8]">
          ...
          <div className="grid gap-3 rounded-[22px] border border-white/8 bg-black/24 p-4 md:grid-cols-[1.2fr_0.8fr_0.8fr] md:items-center" data-testid="owner-shop-identity-card">
            <div className="min-w-0">
              <p className="text-xs font-black uppercase tracking-[0.16em] text-[#C4F24E]">Shop identity</p>
            ...
            <div className="rounded-[18px] border border-white/8 bg-white/[0.035] p-4">
              ...
              <p className={cn("mt-2 text-lg font-black", ownerKioskShopId ? "text-[#C4F24E]" : "text-amber-300")}>{shopStatusLabel}</p>
              <p className="mt-1 text-xs leading-5 text-white/50">{shopStatusDetail}</p>
            </div>
            <Link
              href="/dashboard/owner/more?section=profile"
              className="inline-flex min-h-12 items-center justify-center rounded-[16px] border border-[#C4F24E]/36 px-4 text-sm font-extrabold text-[#C4F24E] transition hover:bg-[#C4F24E]/10"
            >
              Open Settings
            </Link>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <DataStatCard
              ...
              detail={<span className={utilizationPercent !== null && utilizationPercent >= 80 ? "font-bold text-[#C4F24E]" : undefined}>{selectedAvailableMinutes > 0 ? (utilizationPercent !== null && utilizationPercent >= 80 ? "Great" : `${formatDuration(Math.max(0, selectedAvailableMinutes - selectedBookedMinutes))} open`) : "Capacity unavailable"}</span>}
      ...
      <GlassCard className="p-5 sm:p-6" data-testid="barbers-summary">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#C4F24E]">Barbers Summary</p>
          ...
          {sortedScoreboard.length ? (
            <Link href="/dashboard/owner/team" className="text-sm font-extrabold text-[#C4F24E] transition hover:text-[#e4f9b8]">
              View Team
            </Link>
          ) : null}
        </div>
            ...
            <SectionEmptyState
              ...
              action={
                <button
                  type="button"
                  onClick={() => setAddBarbersOpen(true)}
                  className="inline-flex min-h-11 items-center justify-center rounded-full border border-[#C4F24E]/40 px-5 text-sm font-extrabold text-[#C4F24E] transition hover:bg-[#C4F24E]/10"
                >
                  Add Barbers
                </button>
              }
                ...
                <div key={barber.id} className="rounded-[22px] border border-white/8 bg-black/24">
                  <div className="grid gap-4 p-4 lg:grid-cols-[minmax(15rem,1.25fr)_0.75fr_0.8fr_0.7fr_0.8fr_0.65fr_auto] lg:items-center">
                    <button
                      ...
                      className="flex min-w-0 items-center gap-4 rounded-[16px] text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C4F24E]/70"
                    >
                      <Avatar
                        alt={barber.name}
                        ...
                        className={cn(
                          ...
                          barber.statusKind === "active" && "border-[#C4F24E]/80 shadow-[0_0_18px_rgba(196, 242, 78,0.18)]",
                    ...
                    <details className="relative justify-self-start lg:justify-self-end">
                      <summary className="inline-flex h-11 w-11 cursor-pointer list-none items-center justify-center rounded-full border border-white/10 bg-white/[0.035] text-white/62 transition hover:border-[#C4F24E]/30 hover:text-[#C4F24E]" aria-label={`Open actions for ${barber.name}`}>
                  ...
                  {isSelected ? (
                    <div className="border-t border-white/8 px-4 pb-4">
                      <div className="grid gap-3 rounded-[20px] border border-white/8 bg-black/24 p-4 text-sm text-white/62 md:grid-cols-[1fr_1fr_auto] md:items-center">
                        ...
                        <Link href={`/dashboard/owner/money?barberId=${encodeURIComponent(barber.id)}`} className="inline-flex min-h-11 items-center justify-center rounded-full border border-[#C4F24E]/40 px-4 text-sm font-extrabold text-[#C4F24E] transition hover:bg-[#C4F24E]/10">
                          Inspect
                        </Link>
                      </div>
                        ...
                        <div>
                          ...
                          <div className="mt-3 flex flex-wrap gap-2">
                            <button
                              ...
                              className="inline-flex min-h-10 items-center rounded-full border border-white/10 bg-black/20 px-4 text-xs font-black text-white/72 transition hover:border-[#C4F24E]/28 hover:text-[#C4F24E] disabled:cursor-not-allowed disabled:opacity-55"
                            >
      ...
      <GlassCard className="p-5 sm:p-6" data-testid="owner-daily-timeline">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#C4F24E]">Daily Timeline</p>
          ...
          <Link href="/dashboard/owner/schedule" className="text-sm font-extrabold text-[#C4F24E] transition hover:text-[#e4f9b8]">
            Full Schedule
          </Link>
        </div>
            ...
            ownerTimeline.map((appointment) => {
              ...
              return (
                <div key={appointment.id} className="grid gap-4 rounded-[22px] border border-white/8 bg-black/24 p-4 md:grid-cols-[auto_1fr_auto] md:items-center">
                  <div className="rounded-[18px] border border-[#C4F24E]/18 bg-[#C4F24E]/8 px-4 py-3 text-center">
                    <p className="text-xs font-black uppercase tracking-[0.16em] text-[#C4F24E]">Time</p>
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2 text-xs font-black uppercase tracking-[0.12em]">
                      ...
                      <span className="rounded-full border border-[#C4F24E]/18 bg-[#C4F24E]/8 px-3 py-1 text-[#e4f9b8]">{currency(production)}</span>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-2 md:justify-end">
                    <Link
                      href={`/dashboard/owner/schedule?appointmentId=${encodeURIComponent(appointment.id)}`}
                      className="inline-flex min-h-10 items-center justify-center rounded-full border border-[#C4F24E]/40 px-4 text-sm font-extrabold text-[#C4F24E] transition hover:bg-[#C4F24E]/10"
                    >
                      View Details
                    </Link>
                    <Link
                      href={`/dashboard/owner/messages?threadWith=${encodeURIComponent(appointment.barberId)}`}
                      className="inline-flex min-h-10 items-center justify-center gap-2 rounded-full border border-white/10 px-4 text-sm font-extrabold text-white/68 transition hover:border-[#C4F24E]/28 hover:text-[#C4F24E]"
                    >
        ...
        <div className="fixed inset-0 z-50 flex items-end bg-black/78 px-4 py-5 backdrop-blur-xl sm:items-center sm:justify-center" role="dialog" aria-modal="true" aria-labelledby="owner-add-barbers-title">
          <GlassCard className="max-h-[90vh] w-full max-w-6xl overflow-y-auto p-5 sm:p-6">
            <div className="mb-5 flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#C4F24E]">Add Barbers</p>
              ...
              <button
                ...
                className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/[0.035] text-white/70 transition hover:border-[#C4F24E]/35 hover:text-[#C4F24E] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C4F24E]/70"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
      ...
      <GlassCard className="p-5" data-testid="team-relationship-queue">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#C4F24E]">Team relationship queue</p>
                ...
                <div key={barber.barberId} className="grid gap-4 rounded-[20px] border border-white/8 bg-white/[0.035] p-4 md:grid-cols-[1fr_auto] md:items-center">
                  <div className="flex min-w-0 gap-4">
                    <Avatar
                      alt={barber.name}
                      initials={getInitials(barber.name)}
                      className="h-14 w-14 shrink-0 border-2 border-[#C4F24E]/45 bg-[#C4F24E]/10"
                    />
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <p className="truncate text-xl font-black tracking-[-0.03em] text-white">{usernameLabel}</p>
                        <span className="rounded-full border border-[#C4F24E]/20 bg-[#C4F24E]/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.16em] text-[#C4F24E]">Barber</span>
                  ...
                  <div className="flex flex-wrap gap-2 md:justify-end">
                    {barber.username ? (
                      <Link
                        ...
                        className="inline-flex min-h-11 items-center justify-center rounded-full border border-white/10 px-4 text-sm font-extrabold text-white/72 transition hover:border-[#C4F24E]/28 hover:text-[#C4F24E]"
                      >
                        View Profile
                      </Link>
                    ) : null}
                    <button
                      ...
                      className={cn(
                        ...
                        inviteDisabled
                          ...
                          : "border border-[#C4F24E]/42 bg-[#C4F24E] text-black shadow-[0_14px_32px_rgba(196, 242, 78,0.22)] hover:-translate-y-0.5"
                      )}
                    >
                      {inviteLabel}
                    </button>
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-2">
          <div className="rounded-[20px] border border-white/8 bg-black/24 p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="rounded-full border border-[#C4F24E]/20 bg-[#C4F24E]/10 px-3 py-1 text-xs font-black text-[#C4F24E]">
        ...
        <div className="fixed inset-0 z-50 flex items-end bg-black/78 px-4 py-5 backdrop-blur-xl sm:items-center sm:justify-center" role="dialog" aria-modal="true" aria-labelledby="owner-team-invite-confirm-title">
          <GlassCard className="w-full max-w-lg p-5 sm:p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#C4F24E]">Team invite</p>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex min-h-11 items-center justify-center rounded-full border border-[#C4F24E]/42 bg-[#C4F24E] px-5 text-sm font-black text-black shadow-[0_14px_32px_rgba(196, 242, 78,0.22)] transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-55"
              >
                Yes, send invite
              </button>
              <button
                type="button"
                onClick={() => setPendingInviteBarber(null)}
                className="inline-flex min-h-11 items-center justify-center rounded-full border border-white/10 bg-black/20 px-5 text-sm font-black text-white/66 transition hover:border-[#C4F24E]/30 hover:text-[#C4F24E]"
              >
                No, cancel
              </button>
            </div>
