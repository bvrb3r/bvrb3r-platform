            ...
            {selectedRole === "barber" ? (
              <>
                <p className="mt-5 text-sm leading-7 text-white/58">
                  The next step will ask whether you are entering as a freelance, Full Booth Rent, or AutoBooth Rent barber, then attach the correct approval lane before you reach the barber dashboard.
                </p>
                <div className="mt-5 flex flex-wrap gap-3">
                  <Button
                    type="button"
