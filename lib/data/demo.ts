...
export const demoUsers: UserAccount[] = [
  { id: "user-architect", role: "platform_admin", email: "architect@bvrb3r.demo", password: "DevOnly!123", name: "Avery Stone", title: "Founder / Platform Admin", locationIds: ["loc-ybor", "loc-hyde"], platformAdmin: true },
